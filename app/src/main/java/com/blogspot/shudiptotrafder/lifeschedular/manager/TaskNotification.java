...
class TaskNotification {
    ...
    static void notify(final Context context,
        ...
        final String text = res.getString(
                R.string.task_notification_placeholder_text_template, exampleString);
...
//                                context,
//                                0,
//                                new Intent(context, MainActivity.c)),
                ...
                .addAction(
                        ...
                        PendingIntent.getActivity(
                                ...
                                Intent.createChooser(new Intent(Intent.ACTION_SEND)
                                        .setType("text/plain")
                                        .putExtra(Intent.EXTRA_TEXT, "Notification"), "Task status: " + exampleString),
                                PendingIntent.FLAG_UPDATE_CURRENT))
                .addAction(
